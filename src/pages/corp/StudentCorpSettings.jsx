...
import { 
  Moon, Volume2, BookOpen, Bell, Clock, Shield, Check, Info, ChevronRight, Sliders, Type
} from 'lucide-react';
    ...
    <div className="ios-settings-container">
      ...
      <div className="ios-settings-section">
        ...
        <div className="ios-settings-row">
          ...
          <div className="ios-settings-right">
            <span className="ios-detail-text">{membership.centerName || 'O\'quv Markazi'}</span>
          </div>
        </div>
        ...
        <div className="ios-settings-row">
          <div className="ios-settings-left">
            ...
            <span className="ios-row-title">Guruh</span>
          </div>
          <div className="ios-settings-right">
      ...
      <div className="ios-settings-footer" style={{ textAlign: 'center', marginTop: '32px' }}>
        Platforma talqini: v2.4.0 (Corp Edition)<br />
