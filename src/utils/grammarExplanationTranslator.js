...
const EXACT_MAP_RU = {
  ...
  // Short exercise explanations translations
  'Sifat oldidan "to be" kerak: I am tired.': 'Перед прилагательным требуется "to be": I am tired.',
  'Erkak kishi uchun: He.': 'Для мужчин: He.',
  'Tom — erkak ism, shuning uchun He.': 'Том — мужское имя, поэтому He.',
  '"He/She/It" bilan fe\'lga -s qo\'shiladi.': 'С He/She/It к глаголу добавляется -s.',
  '"doesn\'t" dan keyin fe\'l -s olmaydi: like.': 'После "doesn\'t" глагол идет без -s: like.',
  'Ayol kishi uchun: She.': 'Для женщин: She.',
  'Anna — ayol ism, shuning uchun She.': 'Анна — женское имя, поэтому She.',
  '"She" bilan fe\'lga -s qo\'shiladi.': 'С местоимением "She" к глаголу добавляется -s.',
  'Narsa/hayvon uchun: It.': 'Для предметов/животных: It.',
  'Kitob — jonsiz narsa, shuning uchun It.': 'Книга — неодушевленный предмет, поэтому It.',
  '"It" bilan fe\'lga -s qo\'shiladi.': 'С местоимением "It" к глаголу добавляется -s.',
  '"doesn\'t" dan keyin fe\'l -s olmaydi: work.': 'После "doesn\'t" глагол идет без -s: work.',
  'Gap ichida qisqartma to\'g\'ri: She\'s my sister.': 'В предложении сокращение верно: She\'s my sister.',
  'Narsa/ism so\'ralganda: What.': 'При вопросе о предмете/имени: What.',
  'Ko\'pchilik otlarga shunchaki -s qo\'shiladi: books.': 'К большинству существительных просто добавляется -s: books.',
  'Ko\'plikdagi otlar oldidan a/an ishlatilmaydi: dogs.': 'Перед существительными во множественном числе a/an не используется: dogs.',
  'Son va ko\'plik oti kelganda "a" artikli qo\'yilmaydi.': 'При сочетании числительного и мн. ч. артикль "a" не ставится.',
  'two (ikkita) dan keyin ko\'plik shakli: cars.': 'После two (два) идет форма множественного числа: cars.',
  'five (beshta) dan keyin ko\'plik shakli: chairs.': 'После five (пять) идет форма множественного числа: chairs.',
  '"cars" ko\'plikda bo\'lgani uchun "are" keladi.': 'Поскольку "cars" во множественном числе, используется "are".',
  '-s bilan tugagani uchun -es qo\'shiladi: buses.': 'Так как оканчивается на -s, добавляется -es: buses.',
  '-x bilan tugagani uchun -es qo\'shiladi: boxes.': 'Так как оканчивается на -x, добавляется -es: boxes.',
  '-sh bilan tugagani uchun -es qo\'shiladi: dishes.': 'Так как оканчивается на -sh, добавляется -es: dishes.',
  '-ch bilan tugagani uchun -es qo\'shiladi: watches.': 'Так как оканчивается на -ch, добавляется -es: watches.',
  '-es qoidasidagi so\'zlarda -es [iz] tovushini beradi.': 'В словах с правилом -es окончание произносится как [iz].',
  'undosh (b) + y -> y o\'zgarib -ies bo\'ladi: babies.': 'согласная (b) + y -> y меняется на -ies: babies.',
  'undosh (t) + y -> cities.': 'согласная (t) + y -> cities.',
  'unli (o) + y bo\'lgani uchun shunchaki -s: boys.': 'гласная (o) + y -> просто добавляется -s: boys.',
  'unli (e) + y -> keys.': 'гласная (e) + y -> keys.',
  't + y (undosh+y) -> parties.': 't + y (согласная+y) -> parties.',
  'family (undosh l+y) -> families.': 'family (согласная l+y) -> families.',
  'roof — istisno so\'z, shunchaki -s qo\'shiladi: roofs.': 'roof — слово-исключение, просто добавляется -s: roofs.',
  'chef — istisno so\'z: chefs.': 'chef — слово-исключение: chefs.',
  'man ko\'pligi - s emas, men bo\'ladi.': 'множественное число от man — men, а не mans.',
  'children o\'zi ko\'plik, -s qo\'shilmaydi.': 'children уже во множественном числе, -s не добавляется.',
  'fish ko\'plikda ham fish bo\'lib qoladi.': 'fish во множественном числе остается fish.',
  'trousers (shim) — juft narsa, doim ko\'plikda.': 'trousers (брюки) — парный предмет, всегда во множественном числе.',
  'Doimiy ko\'plik otlar bilan "are" ishlatiladi.': 'С существительными только мн. ч. используется "are".',
  'glasses (doimiy ko\'plik) + are.': 'glasses (всегда мн. ч.) + are.',
  'pen undosh tovush [p] bilan boshlanadi: a pen.': 'pen начинается с согласного звука [p]: a pen.',
  'Ko\'plikda "a" bo\'lmaydi.': 'Во множественном числе артикль "a" не используется.',
  'Orttirma daraja (tallest) oldidan: the tallest.': 'Перед превосходной степенью (tallest): the tallest.',
  'Tartib son (third) oldidan: the third.': 'Перед порядковым числительным (third): the third.',
  'Umumiy ma\'nodagi ko\'plik otlar oldida artikl bo\'lmaydi.': 'Перед существительными мн. ч. в общем значении артикль не ставится.',
  'Qo\'lda ushlab turilgan (yaqin) narsa: This.': 'Предмет в руках (близкий): This.',
  'Yaqindagi ko\'plik uchun: these.': 'Для близких предметов во множественном числе: these.',
  'Qo\'lda turgan ko\'plik narsalar: These.': 'Предметы в руках во множественном числе: These.',
  'Uzoqdagi ko\'plik uchun: those.': 'Для удаленных предметов во множественном числе: those.',
  'shoes ko\'plik: These are.': 'shoes во множественном числе: These are.',
  'Tom (erkak kishi, fe\'ldan keyin): him.': 'Том (мужской род, после глагола): him.',
  'Sarah (ayol kishi, fe\'ldan keyin): her.': 'Сара (женский род, после глагола): her.',
  'There are + ko\'plik: apples.': 'There are + множественное число: apples.',
  'pictures ko\'plik -> some.': 'pictures множественное число -> some.',
  'shops ko\'plik -> are not.': 'shops множественное число -> are not.',
  'Do + ega + fe\'l.': 'Do + подлежащее + глагол.',
  'Past Simple da muntazam fe\'lga -ed qo\'shiladi: watched.': 'В Past Simple к правильным глаголам добавляется -ed: watched.',
  'go ning Past Simple shakli: went.': 'прошедшая форма глагола go: went.',
  'read ning Past Simple shakli read yoziladi (/red/ o\'qiladi).': 'прошедшая форма read пишется read (произносится /red/).',
  'not as tall as (oddiy sifat).': 'not as tall as (простая форма прилагательного).',
  'Tom (erkak) -> his.': 'Том (мужской род) -> his.',
  'Anna (ayol) -> her.': 'Анна (женский род) -> her.',
  'She (ayol) -> her car.': 'She (женский род) -> her car.',
  'He (erkak) -> his dog.': 'He (мужской род) -> his dog.',
  'dog (hayvon) -> its ball.': 'dog (животное) -> its ball.',
  'city (narsa/shahar) -> its parks.': 'city (предмет/город) -> its parks.',
  'car (birlik) -> This is.': 'car (ед. ч.) -> This is.',
  'bags (ko\'plik) -> These are.': 'bags (мн. ч.) -> These are.',
  'books (ko\'plik) -> Those are.': 'books (мн. ч.) -> Those are.',
  'Fe\'l (is) kelmoqda: She is.': 'Идет глагол (is): She is.',
  'Ot (book) kelmoqda: Her book.': 'Идет существительное (book): Her book.',
  'phone (birlik) -> This is.': 'phone (ед. ч.) -> This is.',
  'To\'ldiruvchi olmoshi: you.': 'Объектное местоимение: you.',
  'bag (narsa) -> it.': 'bag (предмет) -> it.',
  'keys (ko\'plik) -> them.': 'keys (мн. ч.) -> them.',
  'Ega: He, To\'ldiruvchi: her.': 'Подлежащее: He, Дополнение: her.',
  'Ega: We, To\'ldiruvchi: them.': 'Подлежащее: We, Дополнение: them.',
  'Birlikdagi narsa borligida: There is.': 'При наличии предмета в единственном числе: There is.',
  'a cat (birlik) -> There is.': 'a cat (ед. ч.) -> There is.',
  'birlik inkor: There isn\'t.': 'отрицание в единственном числе: There isn\'t.',
  'many students (ko\'plik) -> There are.': 'many students (мн. ч.) -> There are.',
  'There are + ko\'plik: apples.': 'There are + множественное число: apples.',
  'apples (ko\'plik) -> There are.': 'apples (мн. ч.) -> There are.',
  'cars ko\'plik inkor: There aren\'t.': 'cars отрицание во множественном числе: There aren\'t.',
  'a bank (birlik) -> Is there...?': 'a bank (ед. ч.) -> Is there...?',
  'Birlik savolga javob: there is.': 'Ответ на вопрос в единственном числе: there is.',
  'shops (ko\'plik) -> Are there...?': 'shops (мн. ч.) -> Are there...?',
  'Ko\'plik savolga inkor: there aren\'t.': 'Отрицание на вопрос во множественном числе: there aren\'t.',
  'Birinchi borligi (There is), ikkinchi sifatlanishi (It is).': 'Сначала наличие (There is), затем описание (It is).',
  'Birlik savolga: Yes, there is.': 'На вопрос в единственном числе: Yes, there is.',
  'He (3-shaxs) -> works.': 'He (3-е лицо) -> works.',
  'She (3-shaxs) -> knows.': 'She (3-е лицо) -> knows.',
  'play unli+y -> plays.': 'play гласная+y -> plays.',
  'She (3-shaxs) -> has.': 'She (3-е лицо) -> has.',
  'I\'m writing (am shart!).': 'I\'m writing (обязательно am!).',
  'e tushib qoladi: writing.': 'гласная e опускается: writing.',
  'undosh ikkilanadi: running.': 'согласная удваивается: running.',
  'sit -> sitting (undosh ikkilanadi).': 'sit -> sitting (согласная удваивается).',
  'is running (is yordamchi fe\'li shart!).': 'is running (вспомогательный глагол is обязателен!).',
  'didn\'t dan keyin fe\'l bosh shaklda: didn\'t go.': 'после didn\'t глагол в начальной форме: didn\'t go.',
  'O\'tgan zamon savolida "Did" ishlatiladi.': 'В вопросе прошедшего времени используется "Did".',
  'did dan keyin fe\'l V1: say.': 'после did глагол в V1: say.',
  'Ega so\'ralganda: Who + ate (V2).': 'При вопросе к подлежащему: Who + ate (V2).',
  'Barcha fe\'llar o\'tgan zamonda: closed, turned off, fell asleep.': 'Все глаголы в прошедшем времени: closed, turned off, fell asleep.',
  'Uzun harakat oldidan: While.': 'Перед длительным действием: While.',
  'Qisqa kutilmagan voqea oldidan: when.': 'Перед кратким неожиданным событием: when.',
  'will be watching (be shart).': 'will be watching (обязательно be).',
  'Inkor shakli: won\'t be using.': 'Отрицательная форма: won\'t be using.',
  'Oddiy kelajak harakat: will call.': 'Простое будущее действие: will call.',
  'Inkor gap oxirida: yet.': 'В конце отрицательного предложения: yet.',
  'have been reading (been shart).': 'have been reading (обязательно been).',
  'have (ega bo\'lmoq) - holat fe\'li: has had.': 'have (иметь) - глагол состояния: has had.',
  'Aniq o\'tgan vaqt (last year) -> Past Simple (went).': 'Точное прошедшее время (last year) -> Past Simple (went).',
  'Tarixiy shaxs, o\'tgan zamon: wrote.': 'Историческая личность, прошедшее время: wrote.',
  'Oddiy sifat shakli: big.': 'Простая форма прилагательного: big.',
  'Oddiy sifat: smart.': 'Простая форма прилагательного: smart.',
  'as ... as orasida oddiy sifat turadi: tall.': 'между as ... as простая форма прилагательного: tall.',
  'as...as orasida oddiy sifat: easy.': 'между as...as простая форма прилагательного: easy.',
  'To\'g\'ri so\'z: than.': 'Правильное слово: than.',
  'Uzun sifat: more interesting.': 'Длинное прилагательное: more interesting.',
  'Uzun sifat: more beautiful.': 'Длинное прилагательное: more beautiful.',
  'Orttirma darajada artikl shart: the fastest.': 'В превосходной степени артикль обязателен: the fastest.',
  'Ikkilamchi qiyoslash mumkin emas: smarter than.': 'Двойное сравнение недопустимо: smarter than.',
};
