...
export const EPISODES = {
  ...
  ep07: stub('ep07', 7,  "The Bek's Commission",     1, 'Act I — Contracts of the Misty Valley',     'A powerful regional lord hires Geralt: his daughter has been cursed to transform into a Alvast under moonlight.'),
  ep08: stub('ep08', 8,  'The Moon-Locked Night',    1, 'Act I — Contracts of the Misty Valley',     'Geralt investigates the palace—and discovers the curse was placed by someone inside its walls.'),
  ...
  ep11: stub('ep11', 11, 'The Smell of Blood',       2, 'Act II — The Cynical Crown',               'Geralt crosses a war-ruined landscape. Mercenary hunters are on his trail.'),
  ep12: stub('ep12', 12, 'Audience with the King',   2, 'Act II — The Cynical Crown',               'The Northern King hires Geralt to kill a spy—who turns out to be Sitora.'),
  ep13: stub('ep13', 13, 'The Escape',               2, 'Act II — The Cynical Crown',               'Break out of the royal dungeon—or carry out the assassination.'),
  ep14: stub('ep14', 14, 'Delayed Consequences',     2, 'Act II — The Cynical Crown',               'Every enemy Geralt made in Act I sends hunters after him at once.'),
  ep15: stub('ep15', 15, 'The Black Knights',        2, 'Act II — The Cynical Crown',               'The Imperial elite guard use forbidden ancient signs.'),
  ep16: stub('ep16', 16, 'Night of Betrayal',        2, 'Act II — The Cynical Crown',               "A king's general plans a coup. Geralt must choose which throne to support."),
  ep17: stub('ep17', 17, 'The Palace Fight',         2, 'Act II — The Cynical Crown',               'A gauntlet of combat through palace corridors.'),
  ep18: stub('ep18', 18, 'An Old Friend Returns',    2, 'Act II — The Cynical Crown',               'Someone Geralt spared in Act I appears at the worst possible moment—to save his life.'),
  ep19: stub('ep19', 19, 'Shadow of the Emperor',    2, 'Act II — The Cynical Crown',               'Geralt uncovers the Imperial laboratory creating artificial mutants.'),
  ...
  ep22: stub('ep22', 22, 'The Survivor Camp',        3, 'Act III — The Grey Apocalypse',            "Geralt gathers every ally who survived the game so far into one last camp."),
  ep23: stub('ep23', 23, 'The High Court',           3, 'Act III — The Grey Apocalypse',            'Starvation sparks violence. Geralt must judge—and his verdict shapes the ending.'),
  ep24: stub('ep24', 24, 'The Ancient Tomb',         3, 'Act III — The Grey Apocalypse',            'Geralt descends into the first witcher\'s tomb and finds the legendary Silver Simurgh blade.'),
